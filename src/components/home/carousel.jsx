...
const clients = [
  ...
  { name: "MERITOR", logo: "/logos/Meritor.png" },
  { name: "MEI", logo: "/logos/MEI.jpeg" },
  { name: "Rane", logo: "/logos/Rane.png" },
  { name: "WABCO", logo: "/logos/Wabco.svg" },
  { name: "SKF", logo: "/logos/SKF.png" },
  { name: "TIMKEN", logo: "/logos/Timken.png" },
  { name: "NRB", logo: "/logos/NRB BEARINGS.png" },
  { name: "Gabriel", logo: "/logos/Gabriel.png" },
  { name: "Valeo", logo: "/logos/Valeo.png" },
  { name: "Brakes India", logo: "/logos/Brakes India.png" },
  { name: "LUMNX", logo: "/logos/Lumnx.png" },
  { name: "UNO MINDA", logo: "/logos/UNO MINDA.png" },
];
